#Predict from hours of sleeping snd studying the student test score
#X = (hours studying, hours sleeping),
# y = score on test, xPredicted = 4 hours studying & 8 hours sleeping
#Eng Hesham Asem
# https://www.youtube.com/watch?v=Zvi3xmcMkaY&list=PL6-3IRz2XF5UX-Yi32r925nsgW-3GrnSa&index=16
import numpy as np
